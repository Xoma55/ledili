...
<form id="form-option_price<?php echo $product_id; ?>">
 <table class="be-list" id="table-option_price<?php echo $product_id; ?>">
  ...
  <tfoot>
   <tr>
    <td class="center"><a onclick="addOptionPriceRow(<?php echo $product_id; ?>);" class="btn btn-success btn-xs" title="<?php echo $text_add; ?>"><i class="fa fa-plus"></i></a></td>
    <td class="center" colspan="11"><a class="btn btn-success" onclick="editTool(<?php echo $product_id; ?>, 'option_price', 'upd');"><?php echo $text_edit; ?></a></td>
   </tr>
  </tfoot>
 </table>
</form>
...
function addOptionPriceRow(product_id) {
	...
	html += '  <td class="center"><a onclick="$(this).parents(\'tbody:first\').remove();" class="btn btn-danger btn-xs" title="<?php echo $text_delete; ?>"><i class="fa fa-minus"></i></a></td>';
