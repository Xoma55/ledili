  ...
  <tbody>
   <tr>
    ...
    <td class="left">
     ...
     <?php $value = ''; ?>
     <?php if (isset ($attribute['attribute_description'][$language['language_id']]['text'])) { ?>
     ...
     <?php $value = ''; ?>
     <?php if (isset ($attribute['attribute_description'][$language['language_id']]['link'])) { ?>
     <?php $value = $attribute['attribute_description'][$language['language_id']]['link']; ?>
     <input name="attribute[<?php echo $attribute_row; ?>][attribute_description][<?php echo $language['language_id']; ?>][link]" value="<?php echo $value; ?>" />
     <?php } ?>
