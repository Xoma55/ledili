        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-name<?php echo $language['language_id']; ?>">Комментарий</label>
                        <div class="col-sm-10">
                            <input type="text" name="product_description[<?php echo $language['language_id']; ?>][comment]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['comment'] : ''; ?>" placeholder="Комментарий" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                        </div>
                    </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-isbn"><span data-toggle="tooltip" title="Наш Номер Каталог">Наш Номер Каталог</span></label>
                <div class="col-sm-10">
                  <input type="text" name="isbn" value="<?php echo $isbn; ?>" placeholder="Наш Номер Каталог" id="input-isbn" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group" hidden>
                <label class="col-sm-2 control-label"><?php echo $entry_preorder; ?></label>
                <div class="col-sm-10">
              ...
              <div class="form-group" hidden>
                <label class="col-sm-2 control-label"><?php echo $entry_product_available; ?></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($product_available) { ?>
                    <input type="radio" name="product_available" value="1" checked="checked" />
                    <?php echo $text_avail; ?>
                    <?php } else { ?>
                    <input type="radio" name="product_available" value="1" />
                    <?php echo $text_avail; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$product_available) { ?>
                    <input type="radio" name="product_available" value="0" checked="checked" />
                    <?php echo $text_clarify; ?>
                    <?php } else { ?>
                    <input type="radio" name="product_available" value="0" />
                    <?php echo $text_clarify; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <!-- <label class="col-sm-2 control-label" for="input-limitd"><?php echo $entry_limitd; ?></label> -->
                <label class="col-sm-2 control-label" for="input-limitd"><span data-toggle="tooltip" title="<?php echo $help_limitd; ?>"><?php echo $entry_limitd; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="limitd" value="<?php echo $limitd; ?>" placeholder="<?php echo $entry_limitd; ?>" id="input-limitd" class="form-control" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <div class="form-group"><label class="col-sm-2 control-label"
                  ...
                  <div class="col-sm-10"><select id="main_category_id" name="main_category_id" class="form-control">
                      <option value="0"
                              selected="selected"><?php echo $text_none; ?></option> <?php foreach ($product_categories as $category) { ?><?php if ($category['category_id'] == $main_category_id) { ?>
                        <option value="<?php echo $category['category_id']; ?>"
                                selected="selected"><?php echo $category['name']; ?></option> <?php } else { ?>
                        <option
                            value="<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></option> <?php } ?><?php } ?>
                    </select></div>
                </div>
...
$('#product-category').delegate('.fa-minus-circle', 'click', function() {
    var category_id = $(this).parent().find('input[name="product_category\\[\\]"]').val(); $('#main_category_id option[value="' + category_id + '"]').remove();
	$(this).parent().remove();
});
