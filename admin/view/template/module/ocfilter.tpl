              ...
              <div id="tab-general" class="tab-pane active">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="checkbox">
                      <label>
                          <input type="checkbox" name="copy_truncate" value="1" id="input-truncate" checked/>
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="checkbox">
                      <label>
                          <input type="checkbox" name="copy_attribute" value="1" id="input-copy-attribute" checked/>
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="checkbox">
                      <label>
                          <input type="checkbox" name="copy_filter" value="1" id="input-copy-filter" disabled/>
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="checkbox">
                      <label>
                          <input type="checkbox" name="copy_option" value="1" id="input-copy-option" disabled/>
                      </label>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript"><!--
  ...
  $('#button-copy-filter').on('click', function(e) {
    ...
    $.post('index.php?route=module/ocfilter/copyFilters&token=<?php echo $token; ?>', $('[name^=\'copy_\']').serialize(), function(response) {
      if (response['error']) {
        button.button('reset');
