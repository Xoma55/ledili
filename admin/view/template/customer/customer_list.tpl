            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'customer_group') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'birthday') { ?>
                    <a href="<?php echo $sort_birthday; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_birthday; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_birthday; ?>"><?php echo $column_birthday; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['birthday']; ?></td>
