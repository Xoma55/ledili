            ...
            <fieldset>
              ...
              <div class="form-group">
                <div class="form-group"><label class="col-sm-2 control-label"
                  ...
                  <div class="col-sm-10"><select id="config_seo_url_type" class="form-control"
                                                 name="config_seo_url_type"> <?php foreach ($seo_types as $seo_type) { ?><?php if ($seo_type['type'] == $config_seo_url_type) { ?>
                        <option value="<?php echo $seo_type['type']; ?>"
                                selected="selected"><?php echo $seo_type['name']; ?></option> <?php } else { ?>
                        <option
                            value="<?php echo $seo_type['type']; ?>"><?php echo $seo_type['name']; ?></option> <?php } ?><?php } ?>
                    </select></div>
                </div>
                <div class="form-group"><label class="col-sm-2 control-label"><span data-toggle="tooltip"
                                                                                    title="<?php echo $entry_seo_url_include_path_help; ?>"><?php echo $entry_seo_url_include_path; ?></span></label>
                  <div class="col-sm-10"> <?php if ($config_seo_url_include_path) { ?> <label class="radio-inline">
                      <input type="radio" name="config_seo_url_include_path" value="1"
                             checked="checked"/> <?php echo $text_yes; ?> </label> <label class="radio-inline">
                      <input type="radio" name="config_seo_url_include_path" value="0"/> <?php echo $text_no; ?>
                    </label> <?php } else { ?> <label class="radio-inline">
                      <input type="radio" name="config_seo_url_include_path" value="1"/> <?php echo $text_yes; ?>
                    </label> <label class="radio-inline">
                      <input type="radio" name="config_seo_url_include_path" value="0"
                             checked="checked"/> <?php echo $text_no; ?> </label> <?php } ?> </div>
                </div>
                <div class="form-group"><label class="col-sm-2 control-label" for="config_seo_url_postfix"><span
                        data-toggle="tooltip"
                        title="<?php echo $entry_seo_url_postfix_help; ?>"><?php echo $entry_seo_url_postfix; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_seo_url_postfix" value="<?php echo $config_seo_url_postfix; ?>"
