...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        $data['text_avail'] = $this->language->get('text_avail');
        $data['text_clarify'] = $this->language->get('text_clarify');
        ...
        //13-10-2017
        $data['entry_limitd'] = $this->language->get('entry_limitd');
        //20-10-2017
        $data['entry_product_available'] = $this->language->get('entry_product_available');
		...
		//13-10-2017
        $data['help_limitd'] = $this->language->get('help_limitd');
        ...
        if (isset($this->request->post['preorder'])) {
            $data['shipping'] = $this->request->post['preorder'];
        } elseif (!empty($product_info)) {
        ...
        // 20-10-2017
        if (isset($this->request->post['product_available'])) {
            $data['shipping'] = $this->request->post['product_available'];
        } elseif (!empty($product_info)) {
            $data['product_available'] = $product_info['product_available'];
        } else {
            $data['product_available'] = 0;
        }
		...
		//13-10-2017
        if (isset($this->request->post['limitd'])) {
            $data['limitd'] = $this->request->post['limitd'];
        } elseif (!empty($product_info)) {
            $data['limitd'] = $product_info['limitd'];
        } else {
            $data['limitd'] = '';
        }
