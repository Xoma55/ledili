...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_birthday'])) {
			$url .= '&filter_birthday=' . $this->request->get['filter_name'];
		}
		...
		$data['sort_birthday'] = $this->url->link('customer/customer', 'token=' . $this->session->data['token'] . '&sort=birthday' . $url, 'SSL');
