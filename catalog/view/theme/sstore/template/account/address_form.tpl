...
<div id="container">
  ...
  <div class="content">
    <article id="content" class="account-content edit-address">
      <h2 class="col-md-10 col-md-offset-1"><i class="fa fa-map-marker"></i><?php echo $text_edit_address; ?></h2>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        <fieldset class="col-md-6 col-md-offset-3">
          ...
          <?php } ?>
          <div class="form-group">
            <label class="col-xs-6 control-label text-left"><?php echo $entry_default; ?></label>
            <div class="col-xs-6">
              <?php if ($default) { ?>
        ...
        <div class="buttons clearfix col-md-4 col-md-offset-4">
