	...
	public function index() {
		...
		if ($this->config->get('yandex_market_status')) {
			...
			foreach ($products as $product) {
			    ...
			    //file_put_contents('pp.log',print_r($product['price']),FILE_APPEND);
...
//				$data['cbid'] = 15;
				...
				//echo $this->currency->convert($this->tax->calculate($product['price'], $product['tax_class_id']), $shop_currency, $offers_currency);
