...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
        ...
        $this->document->addScript('/catalog/view/theme/sstore/js/input-mask.js');
		...
		$data['text_social_register'] = $this->language->get('text_social_register');
        ...
        if (isset($this->request->post['birthday'])) {
            $data['birthday_d'] = $this->request->post['birthday'];
        } else {
            $data['birthday_d'] = '';
        }
		...
		if ($this->config->get('config_account_id')) {
			...
			if ($information_info) {
				$data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information/agree', 'information_id=' . $this->config->get('config_account_id'), 'SSL'));
			} else {
				$data['text_agree'] = '';
			}
		} else {
	...
	private function validate() {
        ...
        if (isset($_POST['birthday'])) {
            if ( $birthday = strtotime($this->request->post['birthday']) ) {
                if ($birthday > (time()-60*60*24*355*4) || $birthday < (time()-60*60*24*355*84)) {
