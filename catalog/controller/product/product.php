...
class ControllerProductProduct extends Controller {
	...
	public function index() {
        ...
        $data['social_vk'] = $this->config->get('storeset_vk_id');
        $data['social_fb'] = $this->config->get('storeset_facebook_id');
        $data['social_tw'] = $this->config->get('storeset_twitter_id');
		...
		if ($product_info) {
			...
			$data['customDescription'] = array(
			    'code' => !empty($product_info['1c_id']) ? $product_info['1c_id'] : '',
                'manufacturer' => $product_info['manufacturer'],
                'model' => $product_info['model'],
                'sku' => $product_info['sku'] . (!empty($product_info['isbn']) ? ' / ' . $product_info['isbn'] : ''),
            ...
            $data['outOfStockFlag'] = $product_info['stock_status_id'] != '7'; // проверка именно тут, тк ниже врезаются модификации
            ...
            switch($data['stock_status_id']) {
                ...
                case '5':
                    $data['modal_show_status']='<p style="color: #D3514F;">'.$data['stock_status'].'</p>';
                    break;
                case '7':
                    $data['modal_show_status']='<p style="color: #00AA00;">'.$data['stock_status'].'</p>';
                    break;
                case '6':
                    $data['modal_show_status']='<p style="color: #C96300;">'.$data['stock_status'].'</p>';
                    break;
                case '8':
                    $data['modal_show_status']='<p style="color: #354dc9;">'.$data['stock_status'].'</p>';
                    break;
            }
