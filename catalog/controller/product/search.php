...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['search'])) {
			$data['heading_title'] = $this->language->get('heading_title') .  ' <span>(' . $this->request->get['search'] . ')</span>';
		} else {
        ...
        // по дизайну нет блока с уточнениями поп поиску
        $data['showDetailsForSearch'] = false;
