...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
            ...
            //по дизайну подкатегории не показываются
            ...
            if (!empty($ocfilter_page_info) && !empty($ocfilter_page_info['category_id']) && $ocfilter_page_info['category_id'] == $category_info['category_id']) {
