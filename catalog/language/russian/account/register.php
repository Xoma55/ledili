...
$_['text_account_already'] = 'Если Вы уже зарегистрированы, перейдите на страницу авторизации.';
...
$_['text_agree']           = 'Я прочитал <a href="%s" class="agree">Политика безопасности</a> и согласен с условиями';
$_['text_select_country']  = 'Страна';
$_['text_select_region']   = 'Регион / Область';
$_['text_social_register'] = 'Регистрация через соц.сети';
...
$_['error_birthday']       = 'Дата Рождения введена некорректно!';
