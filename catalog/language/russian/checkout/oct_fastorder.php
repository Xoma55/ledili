...
$_['heading_login_block']            = 'Я зарегистрирован';
$_['heading_user_block']             = 'Оформить заказ';
$_['heading_payment_block']          = 'Способы оплаты';
$_['heading_shipping_block']         = 'Способы доставки';
$_['heading_cart_block']             = 'Корзина';

// Button
$_['button_checkout']                = 'Оформить заказ';
//$_['button_confirm']                 = 'Подтвердить заказ'; ABV
...
$_['text_items']                     = 'Товаров: %s'; /*<br>На сумму: %s;*/
...
$_['text_total_title'] 				 = 'Сумма заказа:';
