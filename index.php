...
// dump()
include_once __DIR__ . DIRECTORY_SEPARATOR . 'alcora' . DIRECTORY_SEPARATOR . 'dump-func.php';

// Configuration
if (is_file(__DIR__.'/configs/config-main.php')) {
...
// Database
require_once __DIR__.'/ext-library/db-mysqli.php';
